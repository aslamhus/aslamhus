...
### Spotify API Client 
I built a lightweight Spotify API Cliet library in PHP to query the Spotify database, build playlists and get user data. It offers multiple options for authentication – managing user permissions, server-to-server use cases and refresh tokens. Other features include an ORM design for entities like Artists, Albums, Tracks and Playlists. You can find the repo here: [https://github.com/aslamhus/Spotify/blob/main/README.md]([https://github.com/aslamhus/Spotify/blob/main/README.md](https://github.com/aslamhus/Spotify))
